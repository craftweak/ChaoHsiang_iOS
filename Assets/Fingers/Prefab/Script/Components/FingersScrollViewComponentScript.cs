...
namespace DigitalRubyShared
{
    ...
    public class FingersScrollViewComponentScript : MonoBehaviour
    {
        ...
        [Tooltip("The canvas that ScrollContent is inside of.")]
        ...
        private void Start()
        {
            ...
            ScaleGesture.PlatformSpecificView = Canvas.gameObject;
            ...
            DoubleTapGesture.PlatformSpecificView = Canvas.gameObject;
            ...
            PanGesture.PlatformSpecificView = Canvas.gameObject;
